    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-8">
          <div>
            <h3 className="text-2xl font-black text-slate-900 dark:text-white">{t('form.editTitle')}</h3>
            <p className="text-slate-500 dark:text-slate-400 mt-1">{t('form.editSubtitle')}</p>
          </div>
          <button
            onClick={onClose}
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="font-semibold">{t('labels.expense')}</span>
              </button>
            </div>
          </div>
