...
const SortableStockCard: React.FC<Props> = ({ stock, onRemove }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`p-2 rounded-full ${stock.rate >= 0 ? 'bg-green-100 dark:bg-green-900' : 'bg-red-100 dark:bg-red-900'}`}
        >
          {stock.rate >= 0 ? (
